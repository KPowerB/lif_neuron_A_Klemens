...
async def test_project(dut):
    ...
    # Test medium input for adaptive threshold dynamics
    dut.ui_in.value = 0x59  # input_enable=1, chan_a=43 (medium value)
